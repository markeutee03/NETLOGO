...
to setup ;; this procedure sets up the simulation for start
  ...
  create-turtles number_turtles [ setxy random-xcor random-ycor
    set virus? false set shape "person" set immune false]
...
to recover ;; if our agent has virus, he con recover under probability
  if virus? [
...
to spread
  ;; Turtle-Turtle interactions (AxA)
  ifelse virus? [] [
    if any? other turtles-here with [virus?]
    [
      if immune = false
      [
        ;; Introduce transmission rate
...
"" ""
PENS
"infected" 1 0 -2674135 true "" "plot count turtles with [virus?]"
"removed" 1 0 -4079321 true "" "plot count turtles with [immune]"
